...
<div class="space-y-1 text-center flex flex-col items-center">
    ...
    <h1 class="h1">
        {#key index}
        <h1 transition:slide><span class=" text-7xl bg-gradient-to-br from-red-500 to-purple-600 bg-clip-text text-transparent box-decoration-clone">{greetings[index]}</span></h1>
        {/key}
    </h1>
    <br>
